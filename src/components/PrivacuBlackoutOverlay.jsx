...
// every existing modal), leaving only the eye icon itself visible so it can
// be tapped again to restore. Genuinely nothing behind it is legible —
// unlike the previous "hide just the numbers" behaviour, someone glancing
// at the screen from any angle sees no stock names, no charts, no
// navigation, nothing.
...
export default function PrivacyBlackoutOverlay() {
    ...
    return (
        <div
            ...
            title="Tap to show your screen again"
        >
            <div style={{
